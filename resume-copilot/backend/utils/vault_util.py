...
# Basic Implementation, make a function that extracts the value from the secret so it can be passed later.
# Use get_secrets after including vault_util.py in other parts of project
def get_secrets(secret_data, secret_name):
