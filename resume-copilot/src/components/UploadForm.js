...
function UploadForm({ onAnalysisComplete, onStartUploading }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const parseResponse = await fetch("https://www.resumecopilot.us/api/parse_pdf/", {
        method: "POST",
        body: formData,
      });
      ...
      const analyzeResponse = await fetch("https://www.resumecopilot.us/api/analyze_resume/", {
        method: "POST",
        headers: {
